%#######################################################################
%
%   * SEGmentation to Two (2) Regions of Interest (ROIs) 2 Program *
%
...
%     the series number and ending in "_2rois2.mat."
%
...
%             rd_roiso3.m, rd_roi6.m, tf_coord.m, trnsf2pixel.m, and
...
%
if nmat~=4
  error(' *** ERROR in seg_2rois2:  Not four (4) MAT files!')
end
%
...
% Read ROIs
%
   brois = rd_roiso3(rdir,leg,ld,itroch,4);
%
% Get Femur Slices
%
...
%
   savnam = [mnam(1:end-4) '_2rois2.mat'];
...
% Read ROIs
%
   brois = rd_roiso3(rdir,leg,ld,itroch,5);
%
% Get Femur Slices
%
   rslc = brois(1).rois(1).slice;      % Femur cartilage
