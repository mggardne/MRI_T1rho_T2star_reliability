%#######################################################################
%
%            * ReMove OVERLAPs in Segmentations 7 Program *
%
%          M-File which reads the MS-Excel spreadsheet file,
%     contact_chk7.xlsx, to find the segmentation CSV files and slices
...
%     files rm_overlap7*.ps in the Results\RemoveOverlap folder.
%
...
psnam = fullfile(resdir,'rm_overlap7_');    % Start of PS file name
pstyp = '.ps';          % PS file type
%
% Read Overlap Data from contact_chk7.xlsx
%
% csvdat
%     Column 1:  Subject
%     Column 2:  Visit
