%#######################################################################
%
%  * FIX Subject 7 Remove Overlap (RO) Segmentation CSV File Program *
%
...
%
%     02-May-2022 * Mack Gardner-Morse
%

%#######################################################################
%
% Get Subject Directory and RO CSV File to Fix
%
cdirf = 'MRIR 07-BP\Visit2\T2S\Femur\';
csvf = '007_L_SAGAR_FEM_T2S_LD_V2_AB_RO.csv';
%
