%#######################################################################
%
%             * CONTACT CHecK of Segmentations 2 Program *
%
...
%     contact_chk2_*.ps in the Results\ContactChecks2 folder.  The
%     maximum overlaps are also saved to the MS-Excel spreadsheet, 
%     contact_chk2.xlsx, in the Results\ContactChecks2 folder.
%
...
%
%             2.  MS-Excel spreadsheet "Modified_ROIs_25May2022.xlsx"
...
%
resdir = fullfile('Results','ContactChecks2');   % Results directory
%
...
hdrs = {'Subject' 'Visit' 'Result' 'Leg' 'Load' 'Comprt' 'Slice', ...
        'MaxDist'};
%
psnam = fullfile(resdir,'contact_chk2_');   % Start of PS file name
pstyp = '.ps';          % PS file type
%
% Get Modified CSV File Names
%
rdir = 'Results\NACOB_Final';
xlsnam_inp = 'Modified_ROIs_25May2022.xlsx';
...
%
   if kf==2
     brois = rd_rois(rdirk,leg,ld,itroch,4);
   else
     brois = rd_rois2(rdirk,leg,ld,itroch,4);
   end
%
% Get Femur Data
%
