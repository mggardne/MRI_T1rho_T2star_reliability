function [tc,amp,rss,npx,id,tcpx,amppx,rsspx,nps] = cmprt_ana(v, ...
                             mask,rsls,nrsls,time,ntime,fun,init,t0,opt)
%CMPRT_ANA Given a four-dimensional matrix of T1/T2 intensities from
%          a MRI image volume, a mask, and a vector of spin lock/echo
%          times, calculates the T1rho/T2* map for the volume.
%
%          TC = CMPRT_ANA(V,MASK,RSLS,NRSLS,TIME,NTIME,FUN,INIT) Given
