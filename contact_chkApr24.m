%#######################################################################
%
%        * CONTACT CHecK of Segmentations APRil 2024 Program *
%
...
%
resdir = fullfile('Results','ContactChecksApr24');    % Results directory
%
ifirst = true;          % First write to file
xlsnam = 'contact_chkApr24.xlsx';      % Results spreadsheet
xlsnam = fullfile(resdir,xlsnam);      % Include output directory
hdrs = {'Subject' 'Visit' 'Result' 'Leg' 'Load' 'Comprt' 'Slice', ...
        'MaxDist'};
%
psnam = fullfile(resdir,'contact_chkApr24_');    % Start of PS file name
