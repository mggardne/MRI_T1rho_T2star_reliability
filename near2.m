...
%          X coordinates in the first column and Y coordinates in the
%          second column.  The reference point, XY0, is a row vector
%          with X and Y coordinates.  The index, IDX, into the list to
%          the point nearest the reference point is returned.
%
