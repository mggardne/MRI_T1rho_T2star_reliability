%#######################################################################
%
%             * MRI FIT Reliability 3 Unloaded 2 Program *
%
...
%     mri_fitr3u21.xlsx (loaded ROIs) and mri_fitr3u22.xlsx (unloaded
%     femur ROIs), in the "Results\Unloaded_Femur2" directory.
%
...
%
%             4.  Update of mri_fitr3u.m to read the new segmentation
...
%
resdir = fullfile('Results','Unloaded_Femur2');  % Results directory
%
ifirst1 = true;         % First write to file
xlsnam1 = 'mri_fitr3u21.xlsx';         % Loaded results spreadsheet
xlsnam1 = fullfile(resdir,xlsnam1);    % Include output directory
%
ifirst2 = true;         % First write to file
xlsnam2 = 'mri_fitr3u22.xlsx';         % Unloaded results spreadsheet
...
%
psnam = fullfile(resdir,'mri_fitr3u2_');    % Start of PS file name
...
%
      if nrho~=nroi
        error([' *** ERROR in mri_fitr3u2:  Number of T1rho MAT', ...
...
%
      if nstar~=nroi
        error([' *** ERROR in mri_fitr3u2:  Number of T2* MAT files', ...
...
% Save to MAT File
%
save(fullfile(resdir,'mri_fitr3u2.mat'),'t1r_res','t1r_npx', ...
