...
%                  cmprt_ana4.m, but modified by the combining of deep
%                  and superficial cartilage layers.  Adapted for use
%                  for calculating T1rho/T2* for the knee meniscus.
%
...
id = zeros(4,2);        % Columns: 1 - Compartment and 2 - Position
%
