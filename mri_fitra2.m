%#######################################################################
%
%                 * MRI FIT Reliability All 2 Program *
%
...
%     mri_fitra2.xlsx, in the "Results\All2" directory.
%
...
%
%             4.  Update of mri_fitra.m to read the new segmentation
...
%
resdir = fullfile('Results','All2');   % Results directory
%
ifirst = true;          % First write to file
xlsnam = 'mri_fitra2.xlsx';            % Results spreadsheet
...
hdrs2 = {'Pixels' 'T1R/T2S' 'RSS' 'ValidPix' 'Mean' 'Min' 'Max' ...
         'SD' 'COV'};
%
psnam = fullfile(resdir,'mri_fitra2_');     % Start of PS file name
...
%
      if nrho~=nroi
        error([' *** ERROR in mri_fitra2:  Number of T1rho MAT', ...
...
% Save to MAT File
%
save(fullfile(resdir,'mri_fitra2.mat'),'t1r_res','t1r_npx', ...
