%#######################################################################
%
% * SEGmentation to Regions of Interest (ROIs) CoMParison x2 Program *
%
...
%     in MAT files with the series number and ending in "_roisx2.mat."
...
%     surface.
%
%          ROI radius is twice (x2) the radius of seg_rois_cmp.m.
%
...
%
   pnam1 = [fs '_ROIx2s1.ps'];         % ROI lines print file name
   pnam2 = [fs '_ROIx2s2.ps'];         % ROI areas print file name
   pnam3 = [fs '_ROIx2s3.ps'];         % ROI regions print file name
%
...
% Close Slice Plots
%
   close all;           % Make sure previous plots are closed
%
...
%
   savnam = [mnam(1:end-4) '_roisx2.mat'];
