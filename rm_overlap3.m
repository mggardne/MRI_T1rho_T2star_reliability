%#######################################################################
%
%            * ReMove OVERLAPs in Segmentations 3 Program *
%
%          M-File which reads the MS-Excel spreadsheet file,
%     contact_chk3.xlsx, to find the segmentation CSV files and slices
...
%
resdir = fullfile('Results','RemoveOverlap3');   % Results directory
psnam = fullfile(resdir,'rm_overlap3_');    % Start of PS file name
pstyp = '.ps';          % PS file type
%
% Read Overlap Data from contact_chk3.xlsx
%
% csvdat
%     Column 1:  Subject
%     Column 2:  Visit
...
%     Column 5:  Load
%
datdir = fullfile('Results','ContactChecks3');
xlsnam = 'contact_chk3.xlsx';
% sht = 'Combined Data';
sht = 1;
