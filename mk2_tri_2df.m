function [tri1,tri2,xy,xym] = mk2_tri_2df(dat,dist,scal,tol,iplt)
...
%
%                3.   M-files midline.m, near2.m, lsect2.m and
%                lsect2a.m must be in the current directory or path.
%
...
d = xyi-xy1(1,:);
d = d*d';
if d>diste/min(scal)    % Bone line within 2 DIST of cartilage end points
  id1 = 2;
end
