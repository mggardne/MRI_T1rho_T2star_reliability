%#######################################################################
%
%              * CONTACT CHecK of Segmentations Program *
%
...
%             pts2lin.m, rd_roi6.m and rd_rois.m must be in the current
%             directory or path.
%
%     21-Mar-2022 * Mack Gardner-Morse
%
...
% Read Segmentations
%
            brois = rd_rois(rdirk,leg,ld,itroch,5);
%
% Get Femur Data
%
            fc = brois(1).rois(1);     % Femur cartilage ROIs
