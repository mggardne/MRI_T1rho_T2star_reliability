%#######################################################################
%
%                 * ReaD DICOM Volume Data 1 Program *
%
...
%
%          Uses elastix parameter file Parameters_RigidBody1.txt.
%
...
%             MelastiX.
%
%             4.  Elastix parameter file, Parameters_RigidBody1.txt,
...
%             file.
%
%     12-Jan-2022 * Mack Gardner-Morse
%
%     14-Jan-2022 * Mack Gardner-Morse * 1. Added check and correction
...
%
   ...
   psfile = ['S' snt '_3_1.ps'];       % PS file name
%
...
%
if subj08_AS_V2
  ids = ids(2:ns,:);    % Skip first sequence of T2* series
  ns = ns-1;
end
%
