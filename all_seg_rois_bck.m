...
%     in the lateral and medial tibial compartments and lateral, medial,
%     and trochlear femoral compartments.  The masks are saved in MAT
%     files with the series number and ending in "_arois.mat."
%
...
%
%             3.  The M-filesv cr_maskf.m, cr_maskt.m, fix_gap.m,
...
%
%     03-Nov-2022 * Mack Gardner-Morse
%
...
%
   ...
   icmprtf = zeros(nrsl,1);            % Femoral compartments (1 - lateral, 2 - medial, 3 - trochlear)
...
%
      ...
      if icmprtf(k)==3
        img1(maskf(:,k)) = cmx/2;      % Green - Trochlea
      end
